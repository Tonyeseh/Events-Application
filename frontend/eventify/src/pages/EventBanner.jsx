      ...
      <div className='my-10'>
        <div className='mx-10 md:mx-24 text-[#2b293d]'>
          ...
          <div>
            ...
            <input
              className='block mt-5 w-full md:w-2/3 text-base text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400'
          ...
          <div className='flex gap-5 justify-end my-5'>
            ...
            <Link to='/create-event/ticketing'>
