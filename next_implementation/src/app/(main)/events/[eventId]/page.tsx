import { fecthEvent } from "@/app/lib/db";
import { getMaxDate } from "@/app/lib/utils/dateUtils";
import UserCard from "@/app/ui/event/userCard";
import UserDataSuspense from "@/app/ui/event/userDataSuspense";
...
export default async function Page({
  ...
  const eventData = await fecthEvent(eventId);
  if (!eventData) notFound();
  return (
    <div>
      <>
        <div className="my-7 mx-7 md:mx-12 text-gray-200 border-b">
          <Image
            ...
            height={0}
          />
          <div className="my-7 flex justify-between dark:text-gray-200">
          ...
          <div className="w-full flex flex-wrap justify-between dark:text-gray-300">
            <div className="md:w-1/2">
              <h2 className="text-lg font-bold my-2 dark:text-gray-200">
                Date and Time
              </h2>
            ...
            <div className="md:w-1/2 flex flex-col items-end">
              <button className="bg-yellow-400 dark:text-white font-semibold md:max-w-60 rounded-lg py-3 px-10 mb-5">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
          ...
          <div className="w-full md:w-1/2 lg:w-3/5 my-7">
            ...
            <Suspense fallback={<UserDataSuspense />}>
              <UserCard userId={eventData.userId} />
            </Suspense>
          </div>
