    ...
    <>
      ...
      <form className="mt-4 space-y-5 md:mt-6" action="#">
        ...
        <div className="space-y-5">
          <a
            href="#"
            className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-2 text-sm font-normal text-gray-900 bg-white rounded-lg border border-gray-200 DpMPWwlSESiYA8EE1xKM _xQT_qSXfwWf6ZhwRle4 m_8FxTcpOfmK___hAaJ6 _FONMPVaCsLFJJGDaaIL _bKyZ1er5YE_NnrwOCm9 __8kBLtrR_iuU2wW25Lp dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 DTyjKhtXBNaebZa5L0l9 _OovBxfPdK7Rjv2nh2Ot"
          >
            <svg
