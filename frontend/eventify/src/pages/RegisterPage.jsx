    ...
    <div className='md:w-full md:h-full bg-[#2B293D] flex'>
      <div className='w-2/5'>
        ...
        <div className='text-white font-extrabold text-3xl flex flex-col pr-28 pl-12 tracking-wide md:py-32 leading-10'>
          ...
          <h1>Sign up for personalized recommendations today!</h1>
        </div>
      </div>
      <div className='bg-white rounded-l-3xl px-32 py-20 w-3/5'>
        <h1 className='lg:text-3xl md:text-xl font-bold'>Create Account</h1>
        <form className='flex flex-col md:mt-12 mt-5' onSubmit={handleSubmit}>
          ...
          <label className='text-[#838383]' htmlFor='fName'>
            First Name
          </label>
          <input
            id='fName'
          ...
          />
          <label className='text-[#838383]' htmlFor='lName'>
            Last Name
          </label>
          <input
            id='lName'
        ...
        <p className='text-[#838383] mt-5 text-sm'>
          ...
          <Link className='text-[#5f5f5f]' to='/login'>
            Log In
          </Link>
        </p>
      </div>
