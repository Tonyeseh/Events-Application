    ...
    <>
      ...
      <div className="my-7 mx-7 md:mx-20 text-[#2B293D] border-b">
        <div
          ...
          class="animate-pulse"
        >
          <div class="flex justify-center align-items w-full h-[50vh] md:h-[80vh] bg-gray-300 rounded dark:bg-gray-700">
            <svg
              class="w-10 h-10 md:w-32 md:h-32 my-auto text-gray-200 dark:text-gray-600"
              aria-hidden="true"
            ...
            <div className="w-full">
              ...
              <p className=" font-thin my-2">
                ...
                <span className="align-middle">
                  <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 w-1/2"></div>
                </span>
              </p>
              {/* <img
            ...
            <div className="dark:bg-slate-800 gap-6 flex items-center">
              <div className="bg-gray-100 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
                <div className="flex items-center gap-4">
                  ...
                  /> */}
                  <svg
                    class="w-32 group-hover:w-36 group-hover:h-36 h-32 object-center object-cover rounded-full transition-all duration-500 delay-500 transform text-gray-200 dark:text-gray-600"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 18"
                  ...
                  <div className="w-fit transition-all transform duration-500">
                    <div class="h-2.5 mb-2 ms-2 bg-gray-300 rounded-full dark:bg-gray-600 w-full"></div>
                    <div class="h-2.5 ms-2 bg-gray-300 rounded-full dark:bg-gray-600 w-full"></div>
